...
SET_KEYBOARD, CHOICE, CHECK, GENERATE, RECEIVE = range(5)
...
button6 = "/exit"
keyboard1 = [[button1],[button2],[button5],[button6]]
          ...
          CHOICE:[ 
               MessageHandler(
                    filters.COMMAND | filters.Regex(
                         '^(Проверка на палиндром|Генерация рандомных 3-х букв|Получить заголовок h1)$'), choice
               ),
          ],
          CHECK: [
